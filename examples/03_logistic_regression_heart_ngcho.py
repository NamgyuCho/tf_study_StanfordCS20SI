...
def read_data_sets(train_dir,
    ...
    train_labels_original = np.load('')
    all_labels = np.asarray(range(0, len(train_labels_original)))
    ...
    validation = DataSet(validation_images, validation_labels, dtype=dtype, reshpae=reshape)
